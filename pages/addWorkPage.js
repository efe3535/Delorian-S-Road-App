...
import { CaretLeft, Camera as CamIcon, CameraRotate, Image as ImageIcon, MapPin, Check, Warning } from 'phosphor-react-native';
...
const AddWorkPage = ({ navigation, route }) => {
    ...
    return (
        <ScrollView alwaysBounceVertical={false} style={{ backgroundColor: isDark ? "#1b1b1b" : "#fff" }} contentContainerStyle={{ minHeight: Dimensions.get("screen").height }}>
            ...
            <Text style={{ marginLeft: 30, color: isDark ? "#fff" : "#000000", fontSize: 24, fontWeight: "700" }}>Yol çalışması konumu</Text>
